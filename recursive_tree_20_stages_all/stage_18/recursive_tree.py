...
class RecursiveTreeApp:
    def __init__(self):
        ...
        self.ax.set_title("Drzewo rekurencyjne (2D) - BFS / DFS", fontsize=16, pad=12)
    ...
    def _create_widgets(self):
        ...
        self.btn_generate = Button(ax_generate, "Generuj")
        self.btn_mode = Button(ax_mode, f"Tryb: {self.mode}")
